...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <Users className={`w-8 h-8 mb-2 ${
                selectedUserType === 'customer' ? 'text-orange-600' : 'text-gray-400'
              }`} />
              <span className={`font-medium ${
                selectedUserType === 'customer' ? 'text-orange-600' : 'text-gray-600'
              }`}>
                Customer
              </span>
            </button>
            ...
            >
              <Store className={`w-8 h-8 mb-2 ${
                selectedUserType === 'business' ? 'text-orange-600' : 'text-gray-400'
              }`} />
              <span className={`font-medium ${
                selectedUserType === 'business' ? 'text-orange-600' : 'text-gray-600'
              }`}>
                Business
              </span>
            </button>
